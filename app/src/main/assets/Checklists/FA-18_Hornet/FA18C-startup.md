# FA-18C Hornet Startup Checklist
...
- [ ] Pitot tubes - Covers removed
- [ ] Canopy - Check condition
- [ ] Engine intakes - Inspect for damage/FOD

## Cockpit Entry

- [ ] Ejection seat pins - Check installed (2 pins)
- [ ] Kneeboard and publications - Stow
- [ ] Loose articles - Remove or secure
- [ ] Seat height - Adjust
- [ ] Rudder pedals - Adjust
- [ ] Harness - Connect all fittings
- [ ] Leg restraints - Connect
- [ ] Helmet - Don
- [ ] Oxygen mask - Check and don
...
- [ ] Instrument panel - Check lights functioning
...
- [ ] Oxygen - Check flow and pressure (100%)
- [ ] G-suit - Connect and check
- [ ] Canopy - Close and lock
- [ ] Ejection seat pins - Remove and stow
- [ ] Seat - ARMED
- [ ] Harness - Locked tight
- [ ] Communication - Set frequencies
- [ ] IFF - Set as required
- [ ] TACAN - Set station
- [ ] Altimeter - Set QNH
- [ ] Fuel quantity - Check
...
- [ ] FCS BIT - Execute
- [ ] FCS caution lights - Check clear
- [ ] Stick - Full deflection all directions
...
- [ ] Trim - Test
- [ ] Rudder pedals - Check steering
- [ ] Taxi speed - Not exceed 15 knots in turns
...
- [ ] Engine instruments - Both engines normal
  - [ ] RPM - 80-85% (both engines)
  - [ ] EGT - Normal (both engines)
  - [ ] Fuel flow - Normal (both engines)
  - [ ] Oil pressure - Normal (both engines)
  - [ ] Hydraulic pressure - Normal
  - [ ] Nozzle position - Check normal

## Takeoff

- [ ] Brakes - Hold
- [ ] Throttles - MIL power
- [ ] Engine instruments - Check normal both engines
- [ ] Brakes - Release
- [ ] Afterburner - As required (outboard, then inboard)
- [ ] AB lights - Check illuminated if AB selected
- [ ] Stick - Neutral, check responsive
- [ ] Rudder - Maintain centerline
- [ ] Airspeed - Monitor
- [ ] Rotate - 130-150 KIAS (depends on weight)
- [ ] Angle of attack - 8-10 units initial climb
- [ ] Positive rate - Confirm
- [ ] Landing gear - UP
- [ ] Flaps - AUTO (retract above 250 KIAS)

## After Takeoff / Climb

- [ ] Landing gear - Check up, lights out
- [ ] Flaps - Check retracted (clean config)
- [ ] Climb speed - 350 KIAS / 0.9 Mach
- [ ] Throttles - Set for climb (MIL or less)
- [ ] Afterburner - Cancel when appropriate
- [ ] Engine instruments - Monitor both engines
- [ ] Departure - Execute as cleared
- [ ] ATC - Contact departure frequency
