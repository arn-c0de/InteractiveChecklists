...
def main():
    ...
    # Show short non-sensitive prefixes instead of full identifiers
    device_name_fp = args.device_name[:8] if args.device_name else 'N/A'
    print(f"📱 Device Name (short): {device_name_fp}")
    if args.device_id:
        device_id_fp = args.device_id[:8]
        print(f"🔑 Device ID (short): {device_id_fp}...")
